...
# from CoTr.network_architecture.neural_network import NeuralNetwork
...
from nnunetv2.nets.cotr import CNNBackbone
from nnunetv2.nets.cotr.neural_network import NeuralNetwork
from nnunetv2.nets.cotr.DeTrans.DeformableTrans import DeformableTransformer
from nnunetv2.nets.cotr.DeTrans.position_encoding import build_position_encoding
...
class ResTranUnet(NeuralNetwork):
    """
    ResTran-3D Unet
    """
